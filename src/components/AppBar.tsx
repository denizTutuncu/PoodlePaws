      ...
      <div className="navbar flex flex-row md:mb-2 shadow-lg bg-neutral text-neutral-content">
        ...
        <div className="hidden md:inline md:navbar-center">
          <div className="flex items-stretch">
            ...
            <Link className="btn btn-ghost btn-sm rounded-btn"  href="/mint">
              Mint NFT
            </Link>
            <Link className="btn btn-ghost btn-sm rounded-btn"  href="/display">
              Display NFT
            </Link>
            <Link className="btn btn-ghost btn-sm rounded-btn"  href="/stake">
             Stake NFT
            </Link>
            <Link className="btn btn-ghost btn-sm rounded-btn"  href="/store">
              STORE
            </Link>
            <Link className="btn btn-ghost btn-sm rounded-btn" href="/dao">
              DAO
            </Link>
          </div>
        </div>

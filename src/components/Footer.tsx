    ...
    return (
        <div className="">
            <footer className="mx-auto  flex flex-row p-2 text-center items-center footer bg-neutral text-neutral-content">
                ...
                <img className={styles.flag_image}src='https://media.giphy.com/media/CXTfsZKQaIqVH7dK9C/giphy.gif' alt='The Lira DAO'/>
                <img className={styles.flag_image}src='https://media.giphy.com/media/5r4lrIVzFkRSsdORQw/giphy.gif' alt='The Lira DAO'/>

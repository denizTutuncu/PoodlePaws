                    ...
                    <div className="grid grid-cols-2 md:grid-cols-6 gap-2 md:gap-8 md:space-x-12 relative">
                        <div className='flex flex-col col-span-2 mx-4 items-center md:items-start'>
                            <div className='flex flex-row ml-1'>
                                    <div className='flex flex-row ml-1'>
                                        <Image
                                            src="/PoodlePawsDAO.png"
                                            alt="Poodle Paws DAO icon"
                                            width={156}
                                            height={96}
                                        />
                                    </div>
                            ...
                            <div className="flex md:ml-2">
                                <a href="https://twitter.com/PoodlePawsWT" type="button" className="border-white text-secondary hover:text-white leading-normal hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">

  ...
  return (
    <div className="md:hero mx-auto p-5">
      <div className="md:hero-content flex flex-col">
        <h1 className="text-left text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-tr from-[#9945FF] to-[#14F195]">
            Poodle Paws
        </h1>
        ...
        <h3 className="md:w-full text-left text-slate-300 my-2">
            <p className="max-auto text-left text-xl md:pl-12 text-transparent bg-clip-text bg-gradient-to-tr from-[#9945FF] to-[#14F195]">
                ...
                The governance process of the DAO mandates that for a proposal to be accepted, it must secure at least 60% of the total votes, requiring 54 out of the 89 stakeholders to vote in favor.
            </p>
        </h3>
        ...
        <h3 className="md:w-full text-left text-slate-300 my-2">
            <p className="max-auto text-left text-xl md:pl-12 text-transparent bg-clip-text bg-gradient-to-tr from-[#9945FF] to-[#14F195]">
                While Poodle Paws DAO seeks to become a prominent pet brand in the Web3 era, its vision extends beyond profitability. 
                The DAO plans to generate revenue and sustainability through the creation of additional NFTs and physical products. 
                By leveraging the power of blockchain and NFT technology, Poodle Paws DAO can offer unique and valuable assets to its community, thereby generating profits that will be channeled back into its core mission—supporting animal welfare initiatives worldwide. 
            </p>
        </h3>

        <h3 className="md:w-full text-left text-slate-300 my-2">
            <p className="max-auto text-left text-xl md:pl-12 text-transparent bg-clip-text bg-gradient-to-tr from-[#9945FF] to-[#14F195]">
                In conclusion, Poodle Paws DAO presents an exciting paradigm shift in the pet industry and charitable endeavors. 
                Through its innovative approach to governance, financial systems, and the utilization of NFT technology, Poodle Paws DAO aims to create a model that is not only commercially successful but also significantly contributes to the well-being of animals across the globe. 
                As the DAO continues to grow and evolve, it aspires to inspire a wave of positive change within the Web3 community and beyond.
            </p>
        </h3>
